...
def test_search_logs_generator_shapes() -> None:
    ...
    expected_cols = [
        "event_id", "timestamp", "user_id_masked", "session_id", "country",
        "region", "language", "device_type", "browser_name", "os_name",
        "position", "clicks", "impressions", "serp_features", "latency_ms",
        "page_speed_score", "bounce_rate", "pogo_stick_flag", "reformulation_flag",
        "dwell_time_sec", "scroll_depth", "search_intent", "query_category",
        "search_query_masked", "revenue_estimate_usd", "search_quality_score"
    ]
